...
class Settings(BaseSettings):
    ...
    account: str = Field(default="", description="Trading account (alias for default_account_id)")
    ...
    @validator('default_account_id', always=True)
    def validate_account_mapping(cls, v, values):
        """Map account field to default_account_id if not set"""
        if not v and 'account' in values and values['account']:
